...
class QuartosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quarto" do
    assert_difference("Quarto.count") do
      post quartos_url, params: { quarto: { comprado: @quarto.comprado, item: @quarto.item } }
    end
  ...
  test "should update quarto" do
    patch quarto_url(@quarto), params: { quarto: { comprado: @quarto.comprado, item: @quarto.item } }
